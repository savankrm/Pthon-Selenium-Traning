...
driver.refresh()
driver.switch_to.window(parent_handle)
driver.find_element(By.XPATH,"/html/body/div[1]/header/div/div[1]/div[3]/div/a[4]/div[2]").click()
num=driver.find_elements(By.CLASS_NAME,"a-size-medium a-color-base sc-price sc-white-space-nowrap sc-product-price a-text-bold")
print(num)
